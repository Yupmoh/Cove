...
public sealed class SpawnEnvironment
{
    ...
    public SpawnEnvironment(string probedPath, string dataDir, string cliPath, string workspaceId)
    {
    ...
    public Dictionary<string, string> Build(string paneId, IReadOnlyDictionary<string, string>? callerEnv)
    {
        ...
        env["COVE_PANE_ID"] = paneId;
        env["COVE_WORKSPACE_ID"] = _workspaceId;
        env["COVE_TASK_ID"] = "";
