...
export function menuIA(): MenuSection[] {
  return [
    { role: "appMenu" },
    {
      label: "File",
      items: [
        { id: "new-shore", label: "New Shore", action: "shore.new" },
        { id: "new-bay", label: "New Bay…", action: "bay.create" },
        { id: "new-browser", label: "New Browser", action: "tool.browser" },
        { separator: true },
        { id: "close-nook", label: "Close Nook", action: "nook.close" },
    ...
    },
    {
      label: "Nook",
      items: [
        { id: "split-right", label: "Split Right", action: "nook.split-right" },
        { id: "split-down", label: "Split Down", action: "nook.split-down" },
        { separator: true },
        { id: "next-nook", label: "Next Nook", action: "nook.focus-next" },
        { id: "prev-nook", label: "Previous Nook", action: "nook.focus-prev" },
        { separator: true },
        { id: "zoom-nook", label: "Maximize Nook", action: "nook.maximize" },
        { id: "find", label: "Find in Nook…", action: "nook.find" },
      ],
    },
    {
      label: "Shore",
      items: [
        { id: "next-shore", label: "Next Shore", action: "shore.next" },
        { id: "prev-shore", label: "Previous Shore", action: "shore.prev" },
        { id: "pin-shore", label: "Pin / Unpin Shore", action: "shore.pin" },
      ],
    },
    {
      label: "Tools",
