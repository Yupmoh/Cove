...
const ALL_SHOWN: ChromeVisibility = { leftSidebarHidden: false, rightSidebarHidden: false };
const ALL_HIDDEN: ChromeVisibility = { leftSidebarHidden: true, rightSidebarHidden: true };
