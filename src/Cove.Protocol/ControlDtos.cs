...
public sealed record AdapterListItemDto(string Name, string DisplayName, string Accent, string Binary, string? Status = null, string? Version = null, string? BinaryPath = null, string? UpdateCommand = null, string? UninstallCommand = null, string? InstallCommand = null, string? Description = null, string? IconSvg = null, string? Provenance = null);
