...
{
    private sealed class CapturingPaneRegistry : IPaneWriter
    {
    ...
    {
        var registry = new CapturingPaneRegistry();
        var delivery = new AgentMessageDelivery(registry);
        var body = "hello world";

        await delivery.DeliverAsync("pane-1", body, submitPauseMs: 0);
    ...
    public async Task Deliver_ObeysCustomSubmitPause()
    {
        ...
        await delivery.DeliverAsync("pane-1", "body", submitPauseMs: 100);
